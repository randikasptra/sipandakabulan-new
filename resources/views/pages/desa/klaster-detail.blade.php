            ...
            @foreach ($klaster->indikators as $index => $indikator)
                ...
                <div class="card mb-4 border-0 shadow-lg">
                    ...
                    <div class="card-body p-4">
                        ...
                        @if ($isApproved)
                            <div
                                class="alert alert-success border-0 bg-success bg-opacity-10 d-flex align-items-center mb-4">
                                <i class="bi bi-check-circle-fill text-success me-2 fs-5"></i>
                        ...
                        @if (count($indikator->kategoriUploads) > 0)
                            <div class="upload-section">
                                ...
                                @foreach ($indikator->kategoriUploads as $upload)
                                    @php
                                        $berkas = \App\Models\BerkasUpload::whereHas('penilaian', function ($q) use (
                                            $indikator,
                                        ) {
                                    ...
                                    <div class="mb-4 p-3 border rounded-3 bg-light">
                                        ...
                                        @if (!$isApproved)
                                            <input type="file" name="file_{{ $upload->id }}"
