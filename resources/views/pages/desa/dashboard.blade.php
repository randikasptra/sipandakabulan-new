            ...
            <div class="relative bg-gradient-to-br from-blue-800 to-blue-600 p-5 text-white">
                ...
                <div class="relative z-10">
                    <div class="flex justify-between items-start mb-3">
                        ...
                        @php
                        $statusBadgeConfig = match($klaster->status) {
                        'approved' => [
                        ...
                        'text' => strtoupper($klaster->status)
                        ],
                        };
                        @endphp
                        <span class="inline-flex items-center gap-1 text-xs font-semibold px-3 py-1 rounded-full {{ $statusBadgeConfig['color'] }} border">
                            <i class="bi {{ $statusBadgeConfig['icon'] }} text-xs"></i>
...
<style>
    * {
    ...
    .status-danger .status-icon-wrapper {
        background: #fee2e2;
        color: #dc2626;
    }
