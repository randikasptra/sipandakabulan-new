...
<script>
    ...
    // Preview email generation - UBAH DI SINI: @tasikdesa.com -> @evaluasikla.com
    function generateEmailSlug(text) {
        // Hapus "Desa " dari awal jika ada
        let cleanText = text.replace(/^Desa\s+/i, '');
    ...
    document.getElementById('nama_desa').addEventListener('input', function() {
        ...
        if (namaDesa) {
            ...
            // UBAH DI SINI: @tasikdesa.com -> @evaluasikla.com
            previewEmail.textContent = slug + '@evaluasikla.com';
    ...
    // Juga generate email saat halaman load jika ada value
