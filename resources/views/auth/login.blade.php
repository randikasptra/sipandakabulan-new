...
<body
    ...
    <div class="flex items-center justify-center space-x-4 mb-6">
        ...
        <img src="{{ asset('assets/images/LogoKABTASIKMALAYA.png') }}" alt="Logo Kabupaten Tasikmalaya"
            class="w-20 h-20 object-contain drop-shadow-md">
    </div>
    ...
    <div
        class="bg-white/90 backdrop-blur-lg p-8 rounded-3xl shadow-2xl w-full max-w-md border border-white/20 relative overflow-hidden">
        <!-- Efek dekoratif -->
        ...
        @if (session('status'))
            <div
                class="mb-4 p-4 bg-green-100/90 text-green-800 border border-green-300 rounded-lg backdrop-blur-sm animate-pulse">
        ...
        @if (session('error'))
            <div
                class="mb-4 p-4 bg-red-100/90 text-red-800 border border-red-300 rounded-lg backdrop-blur-sm animate-pulse">
                <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-red-600" viewBox="0 0 20 20"
                        fill="currentColor">
                        <path fill-rule="evenodd"
