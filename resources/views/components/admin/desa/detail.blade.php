<!-- views/components/admin/desa/detail.blade.php -->
{{-- 🔧 PERBAIKAN: Tambahkan wrapper modal-content agar menjadi modal yang proper --}}
            ...
            <div class="bg-green-50 border border-green-200 rounded-xl p-4">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between items-center py-2 border-b border-green-100">
                        ...
                        <span class="text-gray-800 font-semibold text-xs lg:text-sm">
                            {{ $desa->created_at ? $desa->created_at->format('d M Y H:i') : 'N/A' }}
                        </span>
                    </div>
                    <div class="flex justify-between items-center py-2">
                        <span class="text-gray-600 text-sm font-medium">Terakhir Update</span>
                        <span class="text-gray-800 font-semibold text-xs lg:text-sm">
                            {{ $desa->updated_at ? $desa->updated_at->format('d M Y H:i') : 'N/A' }}
                        </span>
                    </div>
                </div>
            </div>
